#pragma checksum "E:\VS Working\.net core\ERestaurant\Views\Group\List.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2ff6c596812c5d165ac515a349d41baf1d7b5341"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2ff6c596812c5d165ac515a349d41baf1d7b5341", @"/Views/Group/List.cshtml")]
...
<script>
    ...
    ");
            ...
            WriteLiteral(@"e) {
                ...
                axios.post(""/Group/EditGroup"", data).then(res => {
                    if (res.data.status == true) {
                        alert(""添加成功！"");
                        this.close()
                        this.bindData();
